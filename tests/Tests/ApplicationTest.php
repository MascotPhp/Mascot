...
namespace Mascot\Tests;

use PHPUnit\Framework\TestCase;
use Mascot\Application;
use Mascot\ControllerCollection;
...
class ApplicationTest extends TestCase
{
    public function testMatchReturnValue()
    {
        ...
        $this->assertInstanceOf('Mascot\Controller', $returnValue);
    ...
    public function testControllersAsMethods()
    {
        ...
        $app->get('/{name}', 'Mascot\Tests\FooController::barAction');
    ...
    public function testApplicationTypeHintWorks()
    {
        ...
        $app->get('/{name}', 'Mascot\Tests\FooController::barSpecialAction');

        $this->assertEquals('Hello Fabien in Mascot\Tests\SpecialApplication', $app->handle(Request::create('/Fabien'))->getContent());
    }
    ...
    public function testPhp7TypeHintWorks()
    {
        ...
        $app->get('/{name}', 'Mascot\Tests\Fixtures\Php7Controller::typehintedAction');
    ...
    public function testRoutesBeforeMiddlewaresTriggeredAfterMascotBeforeFilters()
    {
        $app = new Application();
    ...
    public function testRoutesAfterMiddlewaresTriggeredBeforeMascotAfterFilters()
    {
        $app = new Application();
    ...
    /**
     * @expectedException        \LogicException
     * @expectedExceptionMessage The method "Mascot\Tests\IncorrectControllerCollection::connect" must return a "ControllerCollection" instance. Got: "NULL"
     */
    ...
    public function testOverriddenRoutesFactory()
    {
        ...
        $this->assertInstanceOf('Mascot\Tests\RouteCollectionSubClass', $app['routes']);
    }
}
