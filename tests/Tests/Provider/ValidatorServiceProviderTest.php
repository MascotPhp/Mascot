...
use Mascot\Tests\Provider\ValidatorServiceProviderTest\Constraint\Custom;
use Mascot\Tests\Provider\ValidatorServiceProviderTest\Constraint\CustomValidator;
...
class ValidatorServiceProviderTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Mascot\Provider\Validator\ConstraintValidatorFactory', $app['validator.validator_factory']);

        $validator = $app['validator.validator_factory']->getInstance(new Custom());
        $this->assertInstanceOf('Mascot\Tests\Provider\ValidatorServiceProviderTest\Constraint\CustomValidator', $validator);
    }
