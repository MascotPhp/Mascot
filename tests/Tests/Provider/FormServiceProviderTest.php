...
use Mascot\Provider\SessionServiceProvider;
use Mascot\Provider\TranslationServiceProvider;
use Mascot\Provider\ValidatorServiceProvider;
...
class FormServiceProviderTest extends TestCase
{
    ...
    public function testFormServiceProviderWillLoadTypes()
    {
        ...
        $form = $app['form.factory']->createBuilder('Symfony\Component\Form\Extension\Core\Type\FormType', [])
            ->add('dummy', 'Mascot\Tests\Provider\DummyFormType')
            ->getForm();
     ...
     * @expectedExceptionMessage Invalid form type. The mascot service "dummy" does not exist.
     */
    ...
    /**
     * @expectedException \Symfony\Component\Form\Exception\InvalidArgumentException
     * @expectedExceptionMessage Invalid form type extension. The mascot service "dummy.form.type.extension" does not exist.
     */
    ...
    /**
     * @expectedException \Symfony\Component\Form\Exception\InvalidArgumentException
     * @expectedExceptionMessage Invalid form type guesser. The mascot service "dummy.form.type.guesser" does not exist.
     */
