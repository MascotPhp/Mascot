...
use Mascot\Provider\DoctrineServiceProvider;
    ...
    public function testMultipleConnections()
    {
        ...
        $app->register(new DoctrineServiceProvider(), [
            'dbs.options' => [
                ...
                'sqlite2' => ['driver' => 'pdo_sqlite', 'path' => sys_get_temp_dir().'/mascot'],
            ],
        ]);
        ...
        $this->assertEquals(sys_get_temp_dir().'/mascot', $params['path']);
    }
