...
use Mascot\Provider\ExceptionHandlerServiceProvider;
use Mascot\Provider\RoutingServiceProvider;
use Mascot\Provider\HttpKernelServiceProvider;

/**
 * The Mascot framework class.
 *
