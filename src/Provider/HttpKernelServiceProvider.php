...
use Mascot\AppArgumentValueResolver;
use Mascot\CallbackResolver;
use Mascot\EventListener\ConverterListener;
use Mascot\EventListener\MiddlewareListener;
use Mascot\EventListener\StringToResponseListener;
...
class HttpKernelServiceProvider implements ServiceProviderInterface, EventListenerProviderInterface
{
    ...
    public function register(Container $app)
    {
        ...
        $app['url_helper'] =  function () use ($app) {
